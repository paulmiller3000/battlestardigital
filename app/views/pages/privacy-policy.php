	...
	<section id="main-content">	
		<div class="container">
		  <div class="row justify-content-center">
		    <div class="col-8">
				<ol start="1">
					<li>Hi there, we’re Picon Bay, Inc. of 12157 W. Linebaugh Avenue, Suite 146, Tampa, FL 33626, United States of America (“<strong>Picon Bay</strong>”) and welcome to our privacy policy. This policy sets out how we handle your personal information if you’re a user or visitor to our Sites. It applies across Battlestar Digital, Help My Toddler Sleep, Paul Miller 3000, and Picon Bay (the “<strong>Sites</strong>”).</li>
					<li>When we say ‘we’, ‘us’ or ‘Picon Bay’ it’s because that’s who we are and we own and run the Sites.</li>
						...
						<ol>
							...
							<li>Where this is necessary for purposes which are in our, or third parties, legitimate interests. These interests include:
								<ol>
									...
									<li>training Picon Bay staff about how to best serve our user community;</li>
									<li>improving our products and services.</li>
									<li>providing general administrative and performance functions and activities; and</li>
									<li>processing your job application to Picon Bay.</li>
								</ol>
							</li>
				...
				<ol start="10">
					<li>We will disclose personal information to the following recipients:
						<ol>
							<li>companies that are in the Picon Bay group which are located in the US;</li>
							<li>subcontractors and service providers who assist us in connection with the ways we use personal information (as set out above), in particular: website hosting providers which are located in Brazil and the US; marketing and analytics services which are located in the US; security and fraud prevention services which are located in the US; subscription management services which are located in the US; payment processing services which are located in the US; identification verification services located in the UK; and operational tooling services which are located in the US. Noting that our subcontractors and services providers may also transfer and access such information from  other countries in which they have operations.</li>
				...
				<ol start="11">
					<li>We are based in the United States so your data will be processed in US. Some of the recipients we have described in section 10 above, and to whom we disclose your personal information, are based outside the United States in places like Brazil. We do this on the basis of your consent to this policy. In order to protect your information, we take care where possible to work with subcontractors and service providers who we believe maintain an acceptable standard of data security compliance.</li>
				</ol>
				...
				<ol start="16">
					<li>For more information about cookies, see <a href="http://www.allaboutcookies.org/">http://www.allaboutcookies.org</a>.</li>
				...
				<ol start="24">
					<li>If you have any questions about our privacy practices or the way in which we have been managing your personal information, please contact our privacy officer in writing at 12157 W. Linebaugh Avenue, Suite 146, Tampa, FL 33626, United States of America.</li>
				...
				<p><strong>If you’re a user or visitor in the European Economic Area these rights also apply to you:</strong></p>
				<ol start="1">
				...
				<p><strong>Picon Bay Privacy Policy v3.1, effective date July 2, 2018</strong></p>
		    </div>
		  </div>
		</div>
	</section>
